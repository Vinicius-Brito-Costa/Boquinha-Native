...
import { StyleSheet, View, Image, ImageBackground, Text, FlatList, TouchableOpacity, ScrollView, Dimensions} from 'react-native';
...
export default function Sobre(props){
    return <ScrollView>
        ...
        <View style={styles.containerMain2}>
            ...
            <Text style={styles.frase2}>Para disponibilizar um conteúdo de qualidade, contamos com um time de parceiros de ponta, que por meio de seus materiais nos ajudaram a elaborar nosso projeto seguindo as diretrizes cientificas da saúde.
            </Text>
        </View>
